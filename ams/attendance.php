<?php
    ...
    if($var3=='Student')
    {
        $sql="SELECT *FROM attendance WHERE regid='$var1' AND semid='$var2'";
            ...
            <div class="row">
                <div class="col-sm-8">
                    <div class="row" style="margin-bottom: 2px;">
                        <div class="col-sm-12">
                            <h1 style="color: #d2d2d2; margin-left: 70px;"> My Attendance</h1>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <?php
                    ...
                    {
                        if($var==$row['semid'])
                            echo "<tr><td style='text-align: center'>" . $row["regid"]. "</td><td style='text-align: center'>" . $row["firstname"]. " " . $row["lastname"]. "</td><td style='text-align: center'>" .$row["emailid"]. "</td></tr>";
                    }
                    mysqli_close($conn);
                ?>
            </tbody>
