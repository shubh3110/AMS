            ...
            <div class="row">
                <div class="col-sm-8">
                    <div class="row" style="margin-bottom: 2px;">
                        <div class="col-sm-12">
                            <h1 style="color: #d2d2d2; margin-left: 70px;"><span class="glyphicon glyphicon-registration-mark" style="color: #76FF03; font-size: 40px;"></span>Add or Remove Faculty</h1>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
        ...
        <div class="col-sm-12" style="margin-bottom: 5px;">
            <div class="aa center-block" style="width: 600px; height: 600px; background-color: rgba(0,0,0,0.2);
                ...
                <form role="form" action="includes/register.inc.php" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <button type="submit" name="Faculty_add_submit" class="btn btn-success btn-block pull-right"><span class="glyphicon glyphicon-off"></span>Add</button>
                            </div>
                            <div class="col-sm-6">
                                <button type="submit" name="Faculty_remove_submit" class="btn btn-success btn-block"><span class="glyphicon glyphicon-off"></span>Remove</button>
                            </div> 
                        </div>
                    </form>
            </div>
