            ...
            <div class="row">
                <div class="col-sm-8">
                    <div class="row" style="margin-bottom: 2px;">
                        <div class="col-sm-12">
                            <h1 style="color: #d2d2d2; margin-left: 70px;"><span class="glyphicon glyphicon-registration-mark" style="color: #76FF03; font-size: 40px;"></span> Students Registration</h1>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
