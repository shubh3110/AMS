    ...
    <div class="container-fluid" style="margin-bottom: 5px; height: 600px;">
        <div class="row" style="background-color: #9E9E9E; height: 100%;">
            <div class="col-sm-12" style="margin-bottom: 50px;">
                <p><h2 style="text-align: center; color: #ffffff">Welcome Faculty!!</h2></p>
            </div>
            ...
            <div class="col-sm-12" style="margin-bottom: 10px;">
                <a href="take_attendance.php" style="text-decoration: none;"><h4 style="color: #ffffff; margin-left: 50px;">Take Attendance</h4></a>
            </div>
        </div>
    </div>
