...
?>
    ...
    <div class="container-fluid" style="margin-bottom: 5px; height: 600px;">
        <div class="row" style="background-color: #9E9E9E; height: 100%;">
            ...
            <div class="col-sm-12" style="margin-bottom: 10px;">
                <a href="select_course.php" style="text-decoration: none;"><h4 style="color: #ffffff; margin-left: 50px;">Take Attendance</h4></a>
            </div>
            <div class="col-sm-12" style="margin-bottom: 10px;">
                <a href="my_subjects.php" style="text-decoration: none;"><h4 style="color: #ffffff; margin-left: 50px;">My Subjects</h4></a>
            </div>
        </div>
    </div>
